import { DIDDocument, VerificationMethod, VerificationMethodJwk, VerificationMethodPublicKey58 } from "@sovrahq/did-core";
import { Base, BaseConverter, IVCJsonLDKeyPair, Suite, suiteDecorator } from "@sovrahq/kms-core";
